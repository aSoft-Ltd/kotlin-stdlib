...
open class NumberFormatter @JvmOverloads constructor(
    val options: NumberFormatterRawOptions = NumberFormatterOptions()
) : Formatter<Number> {
    ...
    fun formatDouble(double: Double) = format(double)
}